...
router.post("/verify-email/:token", validate(rules.verifyEmail), controller.verifyEmail);
router.post("/resend-verification", requireAuth, emailLimiter, controller.resendVerification);
